...
def menu():
    ...
    if (esc == 1):
        ...
        print("Regras do Jogo: Você deve escolher entre dois caminhos [1]-Caminho Vermelho e [2]-Caminho Preto seu objetivo é chegar até a sala 9, mas cuidado você tem apenas 7 jogadas ")
        time.sleep(10)
        menu()
    else:
